    ...
    <div className="container mx-auto p-6 space-y-8 max-w-3xl">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-5xl font-bold text-gray-900 mb-4">
          Interactive <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">AI Learning</span> Assistant
        </h1>
        <p className="text-xl text-gray-600 mb-6">
          Share your screen and engage in voice conversations for personalized learning
        </p>
      </div>

      {/* Screen Preview */}
      <Card className="w-full md:w-[640px] mx-auto shadow-lg">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            {!isSharing ? (
              <Button 
                ...
                className={!isConnected ? "border-red-300 text-red-700" : "bg-blue-600 hover:bg-blue-700 text-white"}
              >
      ...
      <Card className="w-full md:w-[640px] mx-auto shadow-lg">
        <CardHeader>
          <CardTitle className="text-xl font-semibold text-gray-900">Learning Conversation</CardTitle>
        </CardHeader>
        <CardContent>
          <ScrollArea className="h-[400px] pr-4">
            <div className="space-y-4">
              {messages.map((message, index) => (
                ...
                >
                  <div className={`h-8 w-8 rounded-full flex items-center justify-center ${message.sender === "Gemini" ? "bg-gradient-to-r from-blue-600 to-purple-600" : "bg-gray-700"}`}>
